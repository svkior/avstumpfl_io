...
return {
    ...
    b64 = function(data)
        ...
        local filter = ltn12.filter.chain(ltn12.filter.cycle(mimecore.b64, ""), ltn12.filter.cycle(mimecore.wrp, 76, 76))
    ...
    rawb64 = function(data)
        return (mimecore.b64(data)) -- first result of the low-level function is fine here
    end,
    ...
    -- @return decoded string
    unb64 = function(data)
        return (mimecore.unb64(data)) -- first result of the low-level function is fine here
    end,
}
